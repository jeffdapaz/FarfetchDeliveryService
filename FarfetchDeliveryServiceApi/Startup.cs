using FarfetchDeliveryServiceApi.Helpers;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("beta", new OpenApiInfo
                {
                    Title = "Farfetch Delivery Service Exercice - API",
                    Version = "beta",
                    Description = "API responsible to maintain the Points and Routes",
            ...
            byte[] key = Encoding.ASCII.GetBytes(Configuration.GetSection("Token").Value);
